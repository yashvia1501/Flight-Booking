...
const Dashboard = ({bookings,setbookings}) => {  
  ...
  return (
    ...
    <div style={{display:"flex", alignItems:"center",justifyContent:"center",width:"80%",height:"46px",fontSize:"30px",margin: "21px auto"}}>Top Destinations in India</div>
     <div style={{margin: "20px auto",width: "78%",overflowX:"auto"}}>
...
>
      ...
      <div><img alt="New Delhi and NCR" className="Box-sc-kv6pi1-0 hRUYUu" 
      ...
      <div className='image-box'>
      <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/4923/1_4923_02.jpg?ca=8&amp;ce=1&amp;s=345x345&amp;ar=1x1" 
      data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
      <div className='placesName'>Banglore</div>
     </div>

    <div  className='image-box'>
    <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/16850/1_16850_02.jpg?ca=6&amp;ce=1&amp;s=345x345&amp;ar=1x1" 
    data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
    <div className='placesName'>Mumbai</div>
    </div>

    <div  className='image-box'>
    <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/11304/077a5dc2a344a604731be86537916ba0.jpg?ce=0&amp;s=345x345&amp;ar=1x1" 
    data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
    <div className='placesName'>Goa</div>
    </div>

     <div  className='image-box'>
    <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/8801/1_8801_02.jpg?ca=6&amp;ce=1&amp;s=345x345&amp;ar=1x1" 
    data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
    <div className='placesName'>Hyderabad</div>
    </div>

    <div  className='image-box'>
    <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/16854/0abc435fa78c2ca6fb4cb5ec86af89d0.jpg?ce=0&amp;s=345x345&amp;ar=1x1" 
    data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
    <div className='placesName'>Pune</div>
    </div>

    <div  className='image-box'>
    <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/12565/1_12565_02.jpg?ca=6&amp;ce=1&amp;s=345x345&amp;ar=1x1" 
    data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
    <div className='placesName'>Pondicherry</div>
    </div>

    <div  className='image-box'>
    <div><img alt="" className="Box-sc-kv6pi1-0 hRUYUu" src="//pix6.agoda.net/geo/city/12354/1_12354_02.jpg?ca=6&amp;ce=1&amp;s=345x345&amp;ar=1x1" 
    data-element-name="top-destination-city-image" style={{margin: "0px auto"}}/></div>
